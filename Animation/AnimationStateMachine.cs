...
public abstract partial class AnimationStateMachine : Node
{
...
public abstract class Condition
{
    ...
    public static Condition<float> CreateInt(FloatParameter parameter, ComparisonType comparison_type, float value) =>
        new Condition<float>(parameter, comparison_type, value);
}
